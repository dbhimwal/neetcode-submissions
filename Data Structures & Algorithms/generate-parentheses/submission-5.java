class Solution {
    ...
    public List<String> generateParenthesisHelper(int n) {
        if(dp.get(n).size() > 0) {
        ...
        for(int i = 0; i < n; i++) {
            List<String> leftParanthesis = generateParenthesisHelper(i);
            List<String> rightParanthesis = generateParenthesisHelper(n - i - 1);
